    ...
    <Card>
      <CardContent className="flex items-center gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          {lastActiveLabel && (
            <p className="text-xs text-muted-foreground/70">Last active: {lastActiveLabel}</p>
          )}
        </div>
        <DropdownMenu
          trigger={
          ...
          {tempPassword ? (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <code className="flex-1 rounded-lg border border-border bg-secondary px-3 py-2 font-mono text-sm text-foreground">
                  {tempPassword}
                </code>
